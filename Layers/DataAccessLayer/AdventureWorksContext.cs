...
namespace AdventureWorksAPI.DataAccessLayer;
...
public partial class AdventureWorksContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK_ShoppingCartItem_ShoppingCartItemID");
            ...
            entity.HasIndex(e => new { e.TransactionId, e.ProductId }, "IX_ShoppingCartItem_ShoppingCartID_ProductID");

            entity.Property(e => e.TransactionId).HasComment("Shopping cart identification number.");
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.ShoppingCartItems)
                .HasForeignKey(d => d.BusinessEntityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ShoppingCartItem_BusinessEntity");
